...
/*
 * @Manav Singhal
 * Activity.java - To get activity data for record ID passed as input parameter to this program.
 * 
 * */
...
public class Activity {
	...
	private static String PARAMETER = "activity";
	private static String PARAMETER_ID = "49";
	private static String changeLine=System.getProperty("line.separator");

	// Defining Developer Credentials
	...
	private static void sendGetRequest(String reco[]) {
