/*
 * @Manav Singhal
 * MinuteVentilation.java - To get minute_ventilation data for record ID passed as input parameter to this program.
 * 
 * */
package HexoSkin;
...
public class MinuteVentilation {

	private static String PARAMETER = "minuteventilation";
	private static String PARAMETER_ID = "36";
	...
	public MinuteVentilation(String recoo[]) {
		this.reco=recoo;
