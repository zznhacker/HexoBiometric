/*
 * @Manav Singhal
 * Inspiration.java - To get inspiration data for record ID passed as input parameter to this program.
 * 
 * */
package HexoSkin;
...
public class Inspiration {
	...
	private static String PARAMETER = "inspiration";
	private static String PARAMETER_ID = "34";
	...
	public Inspiration(String recoo[]) {
		this.reco=recoo;
