/*
 * @Manav Singhal
 * HeartRateQuality.java - To get heart_rate_quality data for record ID passed as input parameter to this program.
 * 
 * */
package HexoSkin;
...
public class HeartRateQuality {

	private static String PARAMETER = "heartratestatus";
	private static String PARAMETER_ID = "1000";
	...
	public HeartRateQuality(String recoo[]) {
		this.reco=recoo;
	...
	public void getCredentials(String reco[]) throws IOException{
				...
				properties.getPublicKey().length() == 0 || properties.getRecordID().length() == 0 || properties.getUsername().length() == 0)
		{
			...
			System.out.println("here! in credential!");
