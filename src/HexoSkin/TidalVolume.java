/*
 * @Manav Singhal
 * TidalVolume.java - To get tidal_volume data for record ID passed as input parameter to this program.
 * 
 * */
package HexoSkin;
...
public class TidalVolume {

	private static String PARAMETER = "tidalvolume";
	private static String PARAMETER_ID = "37";
	...
	public TidalVolume(String recoo[]) {
		this.reco=recoo;
