/*
 * @Manav Singhal
 * HeartRate.java - To get heart_rate data for record ID passed as input parameter to this program.
 * 
 * */
package HexoSkin;
...
public class HeartRate {
	...
	private static String PARAMETER = "heartrate";
	private static String PARAMETER_ID = "19";
