/*
 * @Manav Singhal
 * BreathingRateQuality.java - To get breathing_rate_quality data for record ID passed as input parameter to this program.
 * 
 * */
package HexoSkin;
...
public class BreathingRateQuality {

	private static String PARAMETER = "breathingratestatus";
	private static String PARAMETER_ID = "1001";
	...
	public BreathingRateQuality(String recoo[]) {
		this.reco=recoo;
