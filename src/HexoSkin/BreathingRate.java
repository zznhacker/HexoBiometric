/*
 * @Manav Singhal
 * BreathingRate.java - To get breathing_rate data for record ID passed as input parameter to this program.
 * 
 * */
package HexoSkin;
...
public class BreathingRate {
	...
	private static String PARAMETER = "breathingrate";
	private static String PARAMETER_ID = "33";
	...
	public BreathingRate(String recoo[]) {
		this.reco=recoo;
	...
	// Method to generate SHA-1 encryption
