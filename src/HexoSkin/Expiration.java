/*
 * @Manav Singhal
 * Expiration.java - To get expiration data for record ID passed as input parameter to this program.
 * 
 * */
package HexoSkin;
...
public class Expiration {
	...
	private static String PARAMETER = "expiration";
	private static String PARAMETER_ID = "35";
	...
	public Expiration(String recoo[]) {
		this.reco=recoo;
